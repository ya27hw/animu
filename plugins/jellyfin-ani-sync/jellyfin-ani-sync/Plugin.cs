...
namespace jellyfin_ani_sync {
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages {
        ...
        public override string Name => "Ani-Sync (AniList)";
        public override Guid Id => Guid.Parse("2a98f1f7-bd58-450f-90e9-b593eb42dfcc");
        public override string Description => "AniList-only sync plugin for Jellyfin with direct ID resolution via AniDB and arm-server.";
